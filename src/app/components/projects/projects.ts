...
export interface Publication {
  pillLabel: string;       // short colored badge, e.g. "LT-EDI @ LDK 2025"
  title: string;
  authors: PubAuthor[];
  venueLine: string;       // full italic citation line, e.g. "Workshop on ..., pages 172–177, 2025"
...
export class Projects {
  ...
  conferences: Publication[] = [
    {
      ...
      venueLine: 'Proceedings of the Workshop on Language Technology for Equality, Diversity, Inclusion (LT-EDI @ LDK 2025), pages 172–177, Unior Press, Naples, Italy — Sep. 2025. 2nd place, LDK 2025 Misogyny Meme Detection Shared Task (macro F1 0.91).',
  ...
  // Timeline stages every submitted paper moves through
  pubStages = ['Submitted', 'Initial Acceptance', 'Camera-Ready Version', 'Online Version'];

  // Work in Progress -> submitted / under review
  // stageIndex reflects the paper's current position on pubStages, based on
  // the actual status recorded for each paper (no dates available yet).
  workInProgress = [
    {
